...
describe('DeviceService', () => {
  ...
  describe('bindDevice', () => {
    ...
    it('should create device with correct fingerprint', async () => {
      ...
      expect(savedDevice).toBeInstanceOf(Device);
      expect(savedDevice.userId).toBe('user-123');
      expect(savedDevice.fingerprint).toBeInstanceOf(DeviceFingerprint);
  ...
  describe('getTrustedDevices', () => {
    ...
    it('should return list of trusted devices', async () => {
      const fingerprint1 = DeviceFingerprint.create({
        userAgent: 'Mozilla/5.0',
        platform: 'MacIntel',
        timezone: 'UTC',
      });

      const fingerprint2 = DeviceFingerprint.create({
    ...
    it('should filter out revoked devices', async () => {
      ...
      device2.revoke(); // Revoke second device
