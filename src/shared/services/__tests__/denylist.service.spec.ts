/**
 * Unit tests for DenylistService
 */
...
describe('DenylistService', () => {
  ...
  beforeEach(async () => {
    ...
    service = module.get<DenylistService>(DenylistService);
  });
  ...
  describe('checkIdentifier', () => {
    ...
    it('should check phone numbers', async () => {
      ...
      const result = await service.checkIdentifier('+12025551234'); // Valid US format
  ...
  describe('blockIdentifier', () => {
    it('should add identifier to denylist', async () => {
      ...
      expect(mockDenylistRepo.add).toHaveBeenCalledWith(
