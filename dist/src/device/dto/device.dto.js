...
exports.RevokeDeviceDto = exports.BindDeviceDto = void 0;
...
], BindDeviceDto.prototype, "userId", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", String)
], BindDeviceDto.prototype, "pushToken", void 0);
class RevokeDeviceDto {
}
exports.RevokeDeviceDto = RevokeDeviceDto;
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
