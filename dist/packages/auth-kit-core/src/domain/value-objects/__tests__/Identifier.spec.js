...
describe('Identifier', () => {
    describe('create', () => {
        ...
        it('should throw error for invalid identifier', () => {
            expect(() => Identifier_1.Identifier.create('invalid')).toThrow();
        });
    });
    describe('hash', () => {
        it('should generate consistent hash for same identifier', () => {
            const id1 = Identifier_1.Identifier.create('user@example.com');
            const id2 = Identifier_1.Identifier.create('user@example.com');
            expect(id1.hash).toBe(id2.hash);
        });
        it('should generate different hash for different identifiers', () => {
            const id1 = Identifier_1.Identifier.create('user1@example.com');
            const id2 = Identifier_1.Identifier.create('user2@example.com');
